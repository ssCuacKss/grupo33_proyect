...
TEST(Persona, ConstructorParametros) {
  Persona p("44XX", "Carlos", "Gutierrez Fernandez", 911804488, "C/ Mesa 1", "sn1990cagufe@sn.es", "20/11/1990");
...
TEST(Persona, ConstructorCopiaDefecto) {
  Persona p("44XX", "Carlos", "Gutierrez Fernandez", 911804488, "C/ Mesa 1", "sn1990paropu@sn.es", "20/11/1990");
  Persona q(p);
  Persona r=q;
  ...
  EXPECT_EQ("sn1990paropu@sn.es", q.getEmail());
